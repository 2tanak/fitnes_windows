...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $current_lang = CurrentLang::calc_lang();
        CurrentLang::set($current_lang);


        View::composer('admin::*', function ($view) use ($current_lang) {
            $view->with(['sys_lang' => new SysLang(), 'lang' => $current_lang ?? 'ru']);
        });
    }
