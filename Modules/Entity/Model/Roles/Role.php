...
use Spatie\Permission\Models\Filter;
...
use App\Models\User;
use Modules\Entity\Model\Traits\Presenter;
/**
 * @property ?\Illuminate\Support\Carbon $created_at
 * @property ?\Illuminate\Support\Carbon $updated_at
 */
class Role extends ModelParent implements RoleContract
{
    use HasPermissions;
	...
	public function permissions_exists($permission_id){
